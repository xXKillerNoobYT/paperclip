...
export const storybookDashboardSummary: DashboardSummary = {
  ...
  boardActions: [
    {
      id: "approval-storybook-ship",
      kind: "approval",
      sourceType: "approval",
      severity: "warning",
      actionType: "ship_release",
      sourceIssueId: "issue-storybook-1",
      sourceIssueIdentifier: "WEB-101",
      sourceIssueTitle: "Ship beta dashboard",
      title: "Approval: Ship Release",
      summary: "Approve the beta dashboard release candidate.",
      reason: "Pending approval requires board review",
      actionLabel: "Review approval",
      href: "/approvals/approval-storybook-ship",
      createdAt: recent(18).toISOString(),
    },
    {
      id: "interaction-storybook-question",
      kind: "issue_thread_interaction",
      sourceType: "issue_thread_interaction",
      severity: "warning",
      actionType: "ask_user_questions",
      sourceIssueId: "issue-storybook-2",
      sourceIssueIdentifier: "WEB-102",
      sourceIssueTitle: "Clarify onboarding copy",
      title: "Clarify onboarding copy",
      summary: "Choose which positioning should be used for the first-run onboarding modal.",
      reason: "Issue thread interaction requires a board response",
      actionLabel: "Respond in thread",
      href: "/issues/WEB-102",
      createdAt: recent(42).toISOString(),
    },
  ],
  budgets: {
    activeIncidents: 1,
