...
describe("codex execute", () => {
  ...
  it("skips the git repo check when the resolved local workspace is not a git checkout", async () => {
    const root = await fs.mkdtemp(path.join(os.tmpdir(), "paperclip-codex-execute-non-git-"));
